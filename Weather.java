...
public class Weather {
    public static void main(String[] args) {
        ...
        double[] farenheit = celciusToFahrenheit(celcius);
        ...
        printTempratures(celcius, "Celcius");
         printTempratures(farenheit, "Farenheit");
     ...
     */
     ...
     public static void printTempratures(double[] temp, String type)
     {
